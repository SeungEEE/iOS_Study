...
class ReceiptsViewModel {
    var selectedSegment: ReceiptsSegement = .first {
        didSet {
    ...
    func startOCR(_ segment: ReceiptsSegement) {
        ...
        /// 이 부분을 DispatchQueue를 삭제하거나 우선순위를 바꿔가면서 돌려보기
    ...
    private func parseWithoutRegex(from text: String) -> ReceiptsModel {
        ...
        while i < lines.count {
            ...
            /// 결제 금액
            if trimmed.contains("결제 금액"), i + 2 < lines.count {
